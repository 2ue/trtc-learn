...
store.$patch({
  sdkAppId: store.sdkAppId || parseInt(getParamKey('sdkAppId'), 10),
  secretKey: store.secretKey || getParamKey('secretKey'),
  userId: store.userId || getParamKey('userId'),
  roomId: store.roomId || getParamKey('roomId'),
});
